...
// ⏱️ On-time percentage display
function OnTimeRate({ percent }: { percent: number | string }) {
          ...
          {loading ? (
            ...
            rows.map((row) => (
              ...
              <TableRow key={row.entryId}>
                ...
                <TableCell>
                  {row.onTimePercent ? (
                    <OnTimeRate percent={row.onTimePercent ?? 0} />
                  ) : (
                    "-"
                  )}
                </TableCell>
                 ...
                 <TableCell>
  {row.responseMinutes !== null && row.responseMinutes !== undefined
    ? `${row.responseMinutes} min`
    : "-"}
</TableCell> 

                <TableCell>
                  {row.distanceMiles ?? 0} mi
                </TableCell>
